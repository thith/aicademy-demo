...
export default function SyllabusPopup({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-30 backdrop-blur-sm transition-opacity duration-200">
      <div 
        ref={popupRef}
        className="relative bg-white rounded-2xl shadow-xl max-h-[90vh] w-full max-w-3xl overflow-hidden opacity-0 scale-95 transition-all duration-300 transform"
      >
        <button 
          onClick={onClose}
        ...
        <div className="overflow-y-auto h-full max-h-[80vh] p-6 md:p-8">
