...
const lessonContent = [
    ...
    paragraphs: [
      ...
      { // Paragraph 2
        sentences: [
          ...
          {
            "text": "Chúng cũng có thể trò chuyện, tìm kiếm chuyên sâu, tạo báo cáo chi tiết, và hỗ trợ chúng ta trong các công việc hàng ngày, như đặt phòng khách sạn hay sắp xếp lịch hẹn.",
            "char_timings": [
  ...
  // { // Commented out old paragraph blocks for reference
  //   type: 'paragraph',
  //   value: [
  //     "AI (Trí tuệ nhân tạo) là công nghệ giúp máy tính trở nên thông minh.",
  //     "Nó có thể học hỏi, nhận diện hình ảnh, và mô phỏng quá trình suy nghĩ của con người."
  //   ]
  // },
  // {
  //   type: 'paragraph',
  //   value: [
  //     "Các AI hiện đại có thể tạo ra nội dung đa dạng như bài viết, hình ảnh, bài hát, video, thậm chí lập trình phần mềm.",
  //     "Chúng cũng có thể trò chuyện, tìm kiếm chuyên sâu, tạo báo cáo chi tiết, và hỗ trợ chúng ta trong các công việc hàng ngày, như đặt phòng khách sạn hay sắp xếp lịch hẹn."
  //   ]
  // },
  // {
  //   type: 'paragraph',
